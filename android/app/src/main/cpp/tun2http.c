...
Java_com_example_tun_1proxy_proxy_service_Tun2HttpVpnService_jni_1init(JNIEnv *env, jobject instance) {
...
JNIEXPORT void JNICALL
Java_com_example_tun_1proxy_proxy_service_Tun2HttpVpnService_jni_1start(
...
JNIEXPORT void JNICALL
Java_com_example_tun_1proxy_proxy_service_Tun2HttpVpnService_jni_1stop(
...
Java_com_example_tun_1proxy_proxy_service_Tun2HttpVpnService_jni_1get_1mtu(JNIEnv *env, jobject instance) {
    return get_mtu();
}


JNIEXPORT void JNICALL
Java_com_example_tun_1proxy_proxy_service_Tun2HttpVpnService_jni_1done(JNIEnv *env, jobject instance) {
...
Java_com_example_tun_1proxy_utils_Util_jni_1getprop(JNIEnv *env, jclass type, jstring name_) {
